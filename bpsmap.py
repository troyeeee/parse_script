...
def read_sv(file_name):
    return pd.read_csv(file_name, header=None, sep='\t',
                        ...
                        #          'inner_ins', 'span_reads', 'junc_reads',
                        #          'id', 'qual', 'filter', 'meta_info', 'anno_info']
                        names=['chrom_5p','pos_5p','strand_5p','chrom_3p','pos_3p','strand_3p','inner_ins','span_reads','junc_reads','id','qual','filter','group','meta_info','gene_5p','gene_3p']
                                 )
...
def get_precise_sv(sv_df, chrom_5p=None, start_5p=None, end_5p=None,
    ...
    # print(res_df.junc_reads)
    # for i in res_df.junc_reads:
    #     print(type(i), int(i), '66')
